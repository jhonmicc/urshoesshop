  ...
  <main>
    ...
    <section class="cart_area section_padding">
      <div class="container">
                    ...
                    <form method="post">
                      ...
                      <td class="invert">
                        <div class="rem">
                          ...
                          <input type="hidden" name="idproduknya" value="<?php echo $result['idproduk'] ?>" \>
        ...
        <?php
        if (isset($_POST['cekout']) && $subtotal == 30000) {
          echo "<script>
        alert('Anda belum memasukkan barang, silahkan membeli barang dahulu!');
        document.location.href = 'product.php';
        </script>";
        } else if (isset($_POST['cekout']) && $subtotal > 30000) {
          echo "<script>
        ...
        <form method="POST">
          <div class="checkout_btn_inner float-right">
            ...
            <a class="checkout_btn_1" href="checkout.php">
              <button name="cekout" class="btn_1">Proceed to checkout</button>
            </a>
          </div>
        </form>
        </div>
