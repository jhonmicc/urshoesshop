                    ...
                    <div class="col-lg-8 mb-5 mb-lg-0">
                        <div class="blog_left_sidebar">
                            ...
                            while ($data = mysqli_fetch_assoc($blog)) {
                                $data2 = $data['idblog'];
                            ?>
                                <article class="blog_item" id="<?= $data2 ?>">
                                    <div class="blog_item_img">
                                        <img class="card-img rounded-0" src="assets/img/blog/<?= $data['gambarblog']; ?>" alt="">
                                    </div>
                                    <div class="blog_details">
                                        <a class="d-inline-block" href="<?= $data['urlblog']; ?>">
                                            <h2> <?= $data['title']; ?> </h2>
                                        </a>
                                        <p><?= $data['content']; ?> </p>
                                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-8 col-md-7">
                        <div class="footer-copy-right">
                            <p>
                                </script> <i class="fa fa-heart" aria-hidden="true"></i> by <a target="_blank">Urshoes shop</a>
                            </p>
                        </div>
                    </div>
