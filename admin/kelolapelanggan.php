...
<head>
	<title>Kelola Pelanggan | Urshoes Admin</title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="kelolapelanggan.php" class="active"><i class="lnr lnr-users"></i> <span>Kelola
									Pelanggan</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				...
				<table id="kategoriproduk" class="table table-striped">
					...
					<tbody>
						<?php
						$staff = mysqli_query($conn, "SELECT * FROM login WHERE role = 'Buyer' ORDER BY id ASC");
						$no = 1;
