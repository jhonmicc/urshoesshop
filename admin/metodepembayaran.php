...
if (isset($_POST['addmethod'])) {
	if (tambahMetodePembayaran($_POST) > 0) {
		echo "<script>
...
// if (isset($_POST["cari"])) {
// 	$displaykategori = cariKategori($_POST["keyword"]);
// }
...
<head>
	<title>Metode Pembayaran | Urshoes Admin</title>
	<meta charset="utf-8">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									...
									<li><a href="metodepembayaran.php" class="active">Metode Pembayaran</a></li>
								</ul>
							</div>
						</li>
		...
		<div class="main">
			...
			<div class="main-content">
				...
				<table id="kategoriproduk" class="table table-striped">
					...
					<tbody>
						<?php
						$metode = mysqli_query($conn, "SELECT * FROM metodepembayaran ORDER BY no ASC");
						$no = 1;
						...
						?>
							<tr>
								...
								<td><?= $p['logo']; ?></td>
								<td>
									<a class="btn btn-info" href="updatemetode.php?id=<?= $p["no"]; ?>"><i class="fa fa-edit"></i>Edit</a>
									<a class="btn btn-danger" href="hapusmetode.php?id=<?= $p["no"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus ?');"><i class="fa fa-remove"></i>Hapus</a>
								</td>
							</tr>
						<?php
						}
